...
var PreloadScene = new Phaser.Class({
    ...
    preload: function () {
        ...
        // So base becomes:              /static/royal_masquerade/
        var base = (window.STATIC_URL || '/static/') + 'royal_masquerade/';

        // ── Images ──────────────────────────────────────────────────────────────
        this.load.atlas('logo',
            base + 'images/logo/logo_texture0_level0.png', //logo.png
            base + 'images/logo/logo_texture0_level0.json');
